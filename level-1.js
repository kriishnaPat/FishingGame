...
function bubblePulse(bubbleObj){
  //Decrease and increase bubble size
  bubbleObj.r += bubbleObj.rSpeed;
  if(bubbleObj.r >= 2) bubbleObj.rSpeed *= -1;
  if(bubbleObj.r <= 5) bubbleObj.rSpeed *= -1;
}
